...
def main(model_name):
    ...
    if (not os.path.exists(model_location)):
        ...
        model.compile(loss=keras.losses.binary_crossentropy, optimizer=optimiser_operators.operator_change_optimisation_function(keras.optimizers.Adam(learning_rate=0.001)), metrics=['accuracy'])
